 ...
 *
 * createImage_emxutil.cpp
 *
 * Code generation for function 'createImage_emxutil'
 *
 */
...
void emxFreeMatrix_cell_wrap_1(cell_wrap_1 pMatrix[11])
{
  int i;
  for (i = 0; i < 11; i++) {
...
void emxInitMatrix_cell_wrap_1(cell_wrap_1 pMatrix[11])
{
  int i;
  for (i = 0; i < 11; i++) {
...
/* End of code generation (createImage_emxutil.cpp) */
